...
function generateMarkdown(
  ...
  let md = `# SpacetimeDB Best Practices\n\n`
  ...
  md += `> generating, or refactoring SpacetimeDB applications. Humans  \n`
  ...
  try {
    ...
    try {
      ...
      metadata = {
        ...
        abstract:
          'Best practices guide for SpacetimeDB TypeScript modules and client SDK, ordered by impact.',
      }
    }
